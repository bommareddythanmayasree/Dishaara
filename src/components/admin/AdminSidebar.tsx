...
const menuItems = [
  ...
  { id: "guides", label: "Tour Guides", icon: Users, badge: "12" },
  { id: "live-map", label: "Live Map", icon: Map, badge: null },
  { id: "pooling", label: "Vehicle Pooling", icon: Car, badge: "5" },
  { id: "offers", label: "Offers & Spots", icon: Tag, badge: null },
  { id: "events", label: "Events", icon: Calendar, badge: "3" },
  { id: "rewards", label: "Loyalty & Rewards", icon: Gift, badge: null },
  { id: "reviews", label: "Reviews", icon: Star, badge: "8" },
  { id: "users", label: "Users", icon: UserCheck, badge: null },
  { id: "payments", label: "Payments", icon: CreditCard, badge: null },
  { id: "safety", label: "Safety Center", icon: Shield, badge: "2" },
